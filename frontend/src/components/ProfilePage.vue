...
const fetchUserDetails = async () => {
  try {
    const response = await axios.get('http://37.9.53.228/api/user/user/me/');
...
const updateProfile = async () => {
  try {
    const response = await axios.put('http://37.9.53.228/api/user/user/me/', form.value);
    user.value = response.data;
...
const changePassword = async () => {
  ...
  try {
    await axios.put('http://37.9.53.228/api/user/user/change-password/', {
...
const confirmDeleteAccount = async () => {
  try {
    await axios.delete('http://37.9.53.228/api/user/user/me/');
